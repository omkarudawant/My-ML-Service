...
class Endpoint(models.Model):
    """
    This class object represents ML API endpoint

    Attributes
    ----------
        name: The name of endpoint used for API URL
        owner: The string owner name
...
class MLAlgorithmStatus(models.Model):
    '''
    The MLAlgorithmStatus represent status of the MLAlgorithm
    which can change during the time.
